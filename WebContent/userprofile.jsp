        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            <thead>
              <tr class="table-heads ">
                  <th class="head-item mbr-fonts-style display-7">
                      ...
                      COLLEGE</th><th class="head-item mbr-fonts-style display-7">
                      YEAR OF GRADUATION</th><th class="head-item mbr-fonts-style display-7">
                      SKILLS</th><th class="head-item mbr-fonts-style display-7">
                      UID</th><th class="head-item mbr-fonts-style display-7">
                     
                      </th></tr>
                  
                   <% ResultSet rs=c1.showProfile();
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><%=rs.getString("name")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("email")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("pno")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("college")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("yog")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("skill")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("uid")%></td></tr><tr>
