...
<%@page import="chitkara.dao.ComplaintDao"%>
    <%ComplaintDao user=(ComplaintDao)session.getAttribute("complaint"); %>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            <thead>
              <tr class="table-heads ">
                  <th class="head-item mbr-fonts-style display-7">
                      ...
                      Complaint</th><th class="head-item mbr-fonts-style display-7">
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><%=rs.getString("name")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("email")%></td><td class="body-item mbr-fonts-style display-7"><%=rs.getString("message")%></td></tr><tr>
